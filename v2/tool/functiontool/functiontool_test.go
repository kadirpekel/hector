...
func TestNew_SimpleArgs(t *testing.T) {
	...
	callableTool, ok := greetTool.(tool.CallableTool)
	if !ok {
...
func TestCall_ValidArgs(t *testing.T) {
	...
	result, err := addTool.(tool.CallableTool).Call(&mockContext{}, map[string]any{
		"a": 5,
		"b": 3,
	})
...
func TestCall_InvalidArgs(t *testing.T) {
	...
	result, err := strictTool.(tool.CallableTool).Call(&mockContext{}, map[string]any{})
...
func TestNewWithValidation(t *testing.T) {
	...
	// Valid path
	result, err := validateTool.(tool.CallableTool).Call(&mockContext{}, map[string]any{
	...
	_, err = validateTool.(tool.CallableTool).Call(&mockContext{}, map[string]any{
		"path": "../../../etc/passwd",
	})
	if err == nil {
...
func TestNew_ComplexTypes(t *testing.T) {
	...
	schema := complexTool.(tool.CallableTool).Schema()
...
func TestCall_FunctionError(t *testing.T) {
	...
	// Success case
	result, err := errorTool.(tool.CallableTool).Call(&mockContext{}, map[string]any{
		"should_fail": false,
	})
	if err != nil {
	...
	// Error case
	_, err = errorTool.(tool.CallableTool).Call(&mockContext{}, map[string]any{
		"should_fail": true,
	})
	if err == nil {
...
func TestCall_TypeConversion(t *testing.T) {
	...
	result, err := numericTool.(tool.CallableTool).Call(&mockContext{}, map[string]any{
