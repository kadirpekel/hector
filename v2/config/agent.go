...
type AgentConfig struct {
	...
	// Default: 5
	IncludeContextLimit *int `yaml:"include_context_limit,omitempty"`

	// IncludeContextMaxLength sets the maximum content length per document (chars).
	// Longer content is truncated.
	// Only used when IncludeContext=true.
	// Default: 500
	IncludeContextMaxLength *int `yaml:"include_context_max_length,omitempty"`
	...
	AgentCardFile string `yaml:"agent_card_file,omitempty"`
...
type ContextConfig struct {
	...
	SummarizerLLM string `yaml:"summarizer_llm,omitempty"`
}
...
type ReasoningConfig struct {
	...
	TerminationConditions []string `yaml:"termination_conditions,omitempty"`
	...
	CompletionInstruction string `yaml:"completion_instruction,omitempty"`
}
