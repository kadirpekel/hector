...
import (
	...
	"github.com/kadirpekel/hector/v2/checkpoint"
	...
	"github.com/kadirpekel/hector/v2/rag"
	...
	"github.com/kadirpekel/hector/v2/tool/searchtool"
	...
	if cfg.Context != nil {
		...
		if cfg.Context.Strategy == "summary_buffer" {
			if cfg.Context.SummarizerLLM != "" {
				...
				summarizerLLM, _ = r.llms[cfg.Context.SummarizerLLM]
