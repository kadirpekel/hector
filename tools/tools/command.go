...
func (t *CommandTool) Execute(ctx context.Context, args map[string]interface{}) (interfaces.ToolResult, error) {
	// Extract parameters
...
func (t *CommandTool) executeCommand(ctx context.Context, command, workingDir string) (interfaces.ToolResult, error) {
...
func (t *CommandTool) createErrorResult(message string, err error) (interfaces.ToolResult, error) {
...
func (t *CommandTool) GetInfo() interfaces.ToolInfo {
	return interfaces.ToolInfo{
		...
		Parameters: []interfaces.ToolParameter{
			{
				Name:        "command",
				Type:        "string",
