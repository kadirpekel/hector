...
func (m *MockContext) Metadata() map[string]any            { return nil }
...
func (m *MockContextWithCallID) SetMetadata(metadata map[string]any) {}
func (m *MockContextWithCallID) Metadata() map[string]any            { return nil }
