...
func (t *SearchTool) buildDescription() string {
	base := "Search the knowledge base for relevant information. When a query is ambiguous or you're unsure, search first instead of asking for clarification. The answer may already be in the indexed documents."
