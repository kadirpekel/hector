...
func (s *Server) initialize() error {
	...
	if config.BoolValue(s.config.Global.Observability.MetricsEnabled, true) || config.BoolValue(s.config.Global.Observability.Tracing.Enabled, false) {
		...
		obsConfig := observability.Config{
			...
			MetricsEnabled: config.BoolValue(s.config.Global.Observability.MetricsEnabled, true),
		}
