...
func (c *ProviderConfigs) Validate() error {
	...
	for name, embedder := range c.Embedders {
		if err := embedder.Validate(); err != nil {
			return fmt.Errorf("embedder provider '%s' validation failed: %w", name, embedder)
		}
	}
	return nil
}
...
// GetProviderType implements providers.ProviderConfig for LLMProviderConfig
func (c *LLMProviderConfig) GetProviderType() providers.ProviderType {
	return providers.ProviderTypeLLM
}

// GetProviderName implements providers.ProviderConfig for LLMProviderConfig
func (c *LLMProviderConfig) GetProviderName() string {
	return c.Type
}
...
// GetProviderType implements providers.ProviderConfig for DatabaseProviderConfig
func (c *DatabaseProviderConfig) GetProviderType() providers.ProviderType {
	return providers.ProviderTypeDatabase
}

// GetProviderName implements providers.ProviderConfig for DatabaseProviderConfig
func (c *DatabaseProviderConfig) GetProviderName() string {
	return c.Type
}
...
// GetProviderType implements providers.ProviderConfig for EmbedderProviderConfig
func (c *EmbedderProviderConfig) GetProviderType() providers.ProviderType {
	return providers.ProviderTypeEmbedder
}

// GetProviderName implements providers.ProviderConfig for EmbedderProviderConfig
func (c *EmbedderProviderConfig) GetProviderName() string {
	return c.Type
}
...
func (c *AgentConfig) Validate() error {
	...
	if c.Database == "" {
		return fmt.Errorf("database provider reference is required")
	}
	if c.Embedder == "" {
		return fmt.Errorf("embedder provider reference is required")
	}
