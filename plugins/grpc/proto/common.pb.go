...
type StatusResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Status        string                 `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"` // "unloaded", "loading", "ready", "error", "crashed", "shutdown", "restarting"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_common_proto_goTypes = []any{
	(*Empty)(nil),              // 0: hector.plugin.Empty
	(*InitializeRequest)(nil),  // 1: hector.plugin.InitializeRequest
	(*InitializeResponse)(nil), // 2: hector.plugin.InitializeResponse
	(*ShutdownRequest)(nil),    // 3: hector.plugin.ShutdownRequest
	(*ShutdownResponse)(nil),   // 4: hector.plugin.ShutdownResponse
	(*HealthRequest)(nil),      // 5: hector.plugin.HealthRequest
	(*HealthResponse)(nil),     // 6: hector.plugin.HealthResponse
	(*ManifestRequest)(nil),    // 7: hector.plugin.ManifestRequest
	(*ManifestResponse)(nil),   // 8: hector.plugin.ManifestResponse
	(*StatusRequest)(nil),      // 9: hector.plugin.StatusRequest
	(*StatusResponse)(nil),     // 10: hector.plugin.StatusResponse
	nil,                        // 11: hector.plugin.InitializeRequest.ConfigEntry
	nil,                        // 12: hector.plugin.ManifestResponse.CapabilitiesEntry
}
var file_common_proto_depIdxs = []int32{
	11, // 0: hector.plugin.InitializeRequest.config:type_name -> hector.plugin.InitializeRequest.ConfigEntry
	12, // 1: hector.plugin.ManifestResponse.capabilities:type_name -> hector.plugin.ManifestResponse.CapabilitiesEntry
